...
from violation_detection.Interface.object_detection.core import box_list
...
def box_voting(selected_boxes, pool_boxes, iou_thresh=0.5):
    ...
    semantic segmentation-aware CNN Prediction', Gidaris and Komodakis, ICCV 2015. For
